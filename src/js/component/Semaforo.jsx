...
const Semaforo = () => {
	...
	//Como seria para poder reutilizar la funcion sin necesidad de expresarla para cada color?
	...
	return (
		<div className="container">
			<div className="caja d-flex mt-5">
				<div className={"rojo"+(setBrillo("rojo"))} onClick={cambiarLuzRoja}></div>
				<div className={"amarillo"+(setBrillo("amarillo"))} onClick={cambiarLuzAmarilla}></div>
				<div className={"verde"+(setBrillo("verde"))} onClick={cambiarLuzVerde}></div>
			</div>
			<button className="btn btn-primary my-5" onClick={encenderSemaforo}>Encender o Apagar el Semaforo</button>
		</div>
	);
};
